...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::livewire('/campaigns/{campaign:uuid}/edit', 'pages::campaigns.create')->name('campaigns.edit');
    Route::livewire('/campaigns/{campaign:uuid}', 'pages::campaigns.show')->name('campaigns.show');
});
